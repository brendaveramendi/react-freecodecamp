...
function App() {
  return (
    <div className="App">
      ...
      <h1>Esto es los dicen nuestros alumnos sobre freecode camp</h1>
      <Testimonio
      nombre='Shawn Wang'
      pais='Singapore'
      imagen='shawn'
      ...
      cargo='Ingeniero de software'
      empresa='ChatDesk'
      testimonio='Da miedo cambiar de carrera. Solo gané la confianza de que podía programar trabajando en las cientos de horas de lecciones gratuitas en freeCodeCamp. En un año tenía un trabajo de seis cifras como ingeniero de software. freeCodeCamp cambió mi vida'/>
      <Testimonio
      nombre='Emma Bostian'
      pais='Suecia'
      imagen='emma'
